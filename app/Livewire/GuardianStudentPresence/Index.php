...
namespace App\Livewire\GuardianStudentPresence;
...
class Index extends Component
{
    ...
    {
        $user = auth()->user();
        $this->studentId = $user->student_guardian->student->id ?? null;
        $this->classRoomId = $user->student_guardian->student->class_room_id ?? null;
    }
    ...
    {
        return auth()->user()->student_guardian->student->class_room->class_schedules ?? null;
    }
    ...
    {
        return view('livewire.guardian-student-presence.index');
    }
}
