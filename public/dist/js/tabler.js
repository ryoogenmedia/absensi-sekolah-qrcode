...
(function (factory) {
    ...
    "undefined" == typeof window
        ...
        : (((r = function (t, o) {
              ...
              return (
                  e && Array.prototype.forEach.call(e.length ? e : [e], t),
                  e
              );
          }),
          (r.update = function (e) {
            ...
            if (details.inserted) {
                ...
                if (appended && checkTail != null) {
                    ...
                    if (this.overwrite === true) {
                        ...
                        checkTail.unshift(
                            this.value.length - details.tailShift,
                        );
                    }
    ...
    class MaskedPattern extends Masked {
        ...
        _rebuildMask() {
            ...
            for (let i = 0; i < pattern.length; ++i) {
                ...
                const maskOpts =
                    ...
                    _defs$char.mask &&
                    !(
                        ((_defs$char2 = defs[char]) === null ||
                        _defs$char2 === void 0
                            ? void 0
                            : _defs$char2.mask.prototype) instanceof
                        IMask.Masked
                    )
                        ? defs[char]
                        : {
        ...
        get unmaskedValue() {
            return this._blocks.reduce(
                (str, b) => (str += b.unmaskedValue),
                "",
            );
        }
    ...
    class MaskedNumber extends Masked {
        ...
        doPrepare(ch) {
            ...
            const [prepCh, details] = normalizePrepare(
                super.doPrepare(ch, flags),
            );
    ...
    class MaskedDynamic extends Masked {
        ...
        set skipInvalid(skipInvalid) {
            if (
                this.isInitialized ||
                skipInvalid !== Masked.DEFAULTS.skipInvalid
            ) {
                console.warn(
            ...
            return (
                ...
                this.compiledMasks.every((m, mi) => {
                    ...
                    const _mask$mi = mask[mi],
                        ...
                        restOpts = _objectWithoutPropertiesLoose(
                            _mask$mi,
                            _excluded2,
                        );
    ...
    var maskElementList = [].slice.call(
    ...
    EventHandler.on(
        ...
        function (event) {
            ...
            if (alreadyOpen) {
                const modalInstance = Modal.getInstance(alreadyOpen);
                if (modalInstance) {
                    modalInstance.hide();
                }
            }
    ...
    dropdownTriggerList.map(function (dropdownTriggerEl) {
        var options = {
            boundary:
                dropdownTriggerEl.getAttribute("data-bs-boundary") ===
                "viewport"
    ...
    tooltipTriggerList.map(function (tooltipTriggerEl) {
        ...
        var options = {
            ...
            html:
                (_ref =
                    tooltipTriggerEl.getAttribute("data-bs-html") ===
                    "true") !== null && _ref !== void 0
                    ? _ref
                    : false,
            placement:
                (_tooltipTriggerEl$get =
                    tooltipTriggerEl.getAttribute("data-bs-placement")) !==
                    null && _tooltipTriggerEl$get !== void 0
                    ? _tooltipTriggerEl$get
                    : "auto",
        };
        ...
        var options = {
            ...
            placement:
                (_popoverTriggerEl$get =
                    popoverTriggerEl.getAttribute("data-bs-placement")) !==
                    null && _popoverTriggerEl$get !== void 0
                    ? _popoverTriggerEl$get
                    : "auto",
        };
