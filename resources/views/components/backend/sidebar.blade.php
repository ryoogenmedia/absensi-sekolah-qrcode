    ...
    <div class="container-fluid">
        ...
        <h1 class="navbar-brand navbar-brand-autodark d-lg-flex d-none">
            <a href="{{ route('home') }}" class="px-3">
                <img src="{{ asset('static/ryoogen/logo/LIGHT LOGO MA PADELO.png') }}" width="100%" height="100%" alt="Tabler">
            </a>
        </h1>

        <h1 class="navbar-brand navbar-brand-autodark d-lg-none d-flex">
            <a href="{{ route('home') }}" class="px-3">
                <img style="width: 150px" src="{{ asset('static/ryoogen/logo/LIGHT LOGO MA PADELO.png') }}" width="100%"
