<div>
    <x-slot name="title">Laporan Presensi Masuk</x-slot>

    <div class="row g-2 align-items-center mb-4">
        <div class="col">
            <div class="page-pretitle">
                Cetak Laporan Prensensi Masuk
            </div>
            <h2 class="page-title">
                Laporan Prensensi Masuk
            </h2>
        </div>

        <div class="col-auto ms-auto d-print-none">
            <div class="btn-list">
                <a href="{{ route('print-report.attendance.qrcode.check-in', ['kelas' => $this->filters['kelas'] ?? '', 'date_start' => $this->filters['startDate'] ?? '', 'date_end' => $this->filters['endDate'] ?? '']) }}"
                    target="_blank" class="btn btn-danger" class="btn btn-danger"><span
                        class="las la-print fs-1 me-2"></span>Cetak
                    Laporan Prensensi Masuk</a>
            </div>
        </div>
    </div>
