        ...
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-lg-6 col-12">
                    ...
                    <x-form.input wire:model="whatsappNumber" name="whatsappNumber" label="Nomor WhatsApp Wali"
                        placeholder="Contoh: 628123456789 (untuk notifikasi)" type="text" required />
                </div>
            </div>
        </div>
